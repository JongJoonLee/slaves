	...
	var imgDir = "../resources/images/calendar/"			// directory for images ... e.g. var imgDir="/img/"
    ...
    */
	...
	function closeCalendar() {
		...
		//event handler 강제로 발생
		var e = jQuery.Event("change");
		jQuery("#"+ctlToPlaceValue.id).trigger(e);
		//=====================
