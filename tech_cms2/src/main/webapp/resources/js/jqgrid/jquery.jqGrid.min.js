...
"_"+b.jgrid.jqID(d),"#"+b.jgrid.jqID(h))[a.p.useProp?"prop":"attr"]("checked",!1))});a.p.selarrrow=[]}b(a).jqGrid("setSelection",C,!0,c)}}}).bind("reloadGrid",function(c,d){/*alert("startReloadGrid");*/!0===a.p.treeGrid&&(a.p.datatype=a.p.treedatatype);d&&d.current&&a.grid.selectionPreserver(a);"local"===a.p.datatype?(b(a).jqGrid("resetSelection"),a.p.data.length&&(S(),O())):a.p.treeGrid||(a.p.selrow=null,a.p.multiselect&&(a.p.selarrrow=[],ha(!1)),a.p.savedRow=[]);a.p.scroll&&V.call(a,!0,!1);if(d&&d.page){var e=d.page;e>a.p.lastpage&&
