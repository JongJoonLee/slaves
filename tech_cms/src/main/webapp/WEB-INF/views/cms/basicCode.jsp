...
<link type="text/css" rel="stylesheet" href="<c:url value='/resources/css/jquery/jquery-ui.min.css'/>"/>
<link type="text/css" rel="stylesheet" href="<c:url value='/resources/css/jquery/jquery-ui.structure.min.css'/>"/>
<link type="text/css" rel="stylesheet" href="<c:url value='/resources/css/jquery/jquery-ui.theme.min.css'/>"/>
...
$(document).ready(function(){
	//메뉴 트리
	$("#menuTree").setTree({
		url: "<spring:url value='/CMS/CODE/list.do'/>",
		postData:{PARENTBOM:"/"},
		rootkey: "/",
		key: "BOM_TEXT",
		parent: "PARENTBOM",
	...
	createGrid("gridList", 
			["기초코드","코드명","코드값","코드설명","시스템사용여부","부모계층","게층","계층레벨","계층텍스트","등록자","등록일","수정자","수정일",""], 
			[
				{name:'BASIC_CD', index:'BASIC_CD',align: 'center', width:100, editable: true, editoptions:{dataEvents:[{type:'change', fn:fnSetCellChange}]}}
				,{name:'CD_NM', index:'CD_NM',align: 'center', width:100, editable: true, editoptions:{dataEvents:[{type:'change', fn:fnSetCellChange}]}}
				,{name:'CD_VALUE', index:'CD_VALUE',align: 'center', width:100, editable: true, editoptions:{dataEvents:[{type:'change', fn:fnSetCellChange}]}}
				,{name:'CD_DESCRIPTION', index:'CD_DESCRIPTION',align: 'center', width:100, editable: true, editoptions:{dataEvents:[{type:'change', fn:fnSetCellChange}]}}
				,{name:'USE_YN', index:'USE_YN',align: 'center', width:100, editable: true, editoptions:{value:"1:0", dataEvents:[{type:'change', fn:fnSetCellChange}]}, edittype:'checkbox', formatter:"checkbox"}
	    		...
	    		,{name:'rowType', width:20, align: 'center', hidden:true}
			], {url:'EMPTY',
				multiselect:true, 
				width:'90%',
				height: 450,
...
function fnReset(){
	...
	jQuery("#jqGrid_gridList").setGridParam({
		url:'<c:url value="/CMS/CODE/detailList.do"/>',
		postData : {									
			pageNo : "1"
		},
...
function fnSave(){		
	...
	for(var idx = (data.length-1); idx >= 0; idx--){
		if(data[idx].rowType == "C" || data[idx].rowType == "U" || data[idx].rowType == "D"){
			...
			objGrid.jqGrid("saveRow", selRows[idx]);
			submitAction2("<c:url value='/CMS/CODE/save.do'/>", 
	...
	<body>
		...
		<div class="box">
			<div class="row">
				...
				<div class="col-xs-9" style="width: 600px;">
