...
<div id="wrap lo">
	<div class="login">
		<form id="loginFrm" action="<c:url value='/j_spring_security_check'/>" method="post">
			<p class="logo"><img src="<c:url value="/resources/images/logo.gif"/>" width="100%" alt="해운거래정보센터 CI" /></p>
			...
			<p class="footer"><img src="<c:url value='/resources/images/logo_s.gif'/>" width="12%" alt="로고" />Copyright © 2015 <b>MEIC</b> All rights reserved</p>
		</form>
	</div>
</div>
<!--//wrap -->