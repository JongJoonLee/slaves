...
var nicEditorConfig = bkClass.extend({
	...
	iconsPath : '../../cms/resources/images/nicEditorIcons.gif',
...
var nicUploadButton = nicEditorAdvancedButton
		.extend({
			nicURI : "/cms/fileuploadBanner.do" /*"http://api.imgur.com/2/upload.json"*/,
			...
			uploadFile : function() {
				...
				C.open("POST", this.ne.options.uploadURI || this.nicURI, false);
				C.onload = function() {
					try {
