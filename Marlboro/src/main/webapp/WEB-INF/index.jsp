...
<div class="form-group">
  <label for="usr">이야기:</label>
<div class="form-inline">
  <form action="">
  <input type="text" class="form-control" id="message" width="100%"/>
								...
								<div class="qa-message-list" id="wallmessages">
										...
										<div class="message-inner">
											<div class="message-head clearfix">
												...
												<div class="user-detail">
													<h5 class="handle">김진수 부장 / PI팀</h5>
													<div class="post-meta">
														<div class="asker-meta">
															<span class="qa-message-what"></span> <span
																class="qa-message-when"> <span
																class="qa-message-when-data">2016년 09월 10일 09시
																	27분</span>
															</span>
											...
											<div class="qa-message-content">떠나 버린 너의 모습을~~ 지우고 버리고
												비워도~~~ 어느새 가득 차버린 내 사랑</div>
										</div>
									</div>
									...
									<div class="message-item" id="m20">
										<div class="message-inner">
											...
											<div class="qa-message-content">잊고 잊혀지고 지우고 처음 만난 그때가
												그리워진 사람 다시 못 올 몇번의 그 계절</div>
										</div>
									</div>
									...
									<div class="message-item" id="m19">
										<div class="message-inner">
											<div class="message-head clearfix">
												...
												<div class="user-detail">
													<h5 class="handle">이종준 대리 / 해외영업팀</h5>
													<div class="post-meta">
														<div class="asker-meta">
															<span class="qa-message-what"></span> <span
																class="qa-message-when"> <span
											...
											<div class="qa-message-content">모든 게 나 ㄸ문인데 왜 니가 더 힘들어
												니가 왜 내맘을 위로해 오~~~!!! 워`!!!!!</div>
										</div>
									</div>
									...
									<div class="message-item" id="m19">
										<div class="message-inner">
											...
											<div class="qa-message-content">잊고 잊혀지고 지우고 처음만난 그때가
												그리워진 사람 다시 못올 몇 번의 그 계절 떠나버린 너의 모습을 지우고 버리고 비워도 어느새 가득 차버린
												내사랑</div>
										</div>
									</div>
									...
									<div class="message-item" id="m18">
										<div class="message-inner">
											...
											<div class="qa-message-content">미안해 라고 안아주고 싶지만 점이 돼버린
												그 뒷모습 오오오오 워허~</div>
										</div>
									</div>
									...
									<div class="message-item" id="m17">
										<div class="message-inner">
											...
											<div class="qa-message-content">언제나 내 마음이라 사랑하던 맘 이라 그리
												아파할 줄 몰랐어</div>
										</div>
									</div>
									...
									<div class="message-item" id="m16">
										<div class="message-inner">
											...
											<div class="qa-message-content">안 된다고 사랑하면 안된다고 하지만 우린
												함께 했지</div>
										</div>
									</div>
									...
									<div class="message-item" id="m5">
										<div class="message-inner">
												...
												<div class="user-detail">
													...
													<div class="post-meta">
														<div class="asker-meta">
															<span class="qa-message-what"></span> <span
																class="qa-message-when"> <span
																class="qa-message-when-data">2016년 09월 08일 11시
																	37분</span>
															</span>
															<!-- <span class="qa-message-who">
												<span class="qa-message-who-pad">by </span>
											...
											<div class="qa-message-content">어느새 가득 차버린 내 사랑</div>
										</div>
									</div>
									...
									<div class="message-item" id="m4">
										<div class="message-inner">
											<div class="message-head clearfix">
												...
												<div class="user-detail">
													<h5 class="handle">조재원 사원 / 현장</h5>
													<div class="post-meta">
														<div class="asker-meta">
															<span class="qa-message-what"></span> <span
																class="qa-message-when"> <span
																class="qa-message-when-data">2016년 09월 03일 10시
																	27분</span>
															</span>
															<!-- <span class="qa-message-who">
												<span class="qa-message-who-pad">by </span>
											...
											<div class="qa-message-content">다시 못 올 몇 벙늬 그 계절 떠나버린
												너의 모습을 지우고 버리고 비워도</div>
										</div>
									</div>
									...
									<div class="message-item" id="m3">
										<div class="message-inner">
											<div class="message-head clearfix">
												...
												<div class="user-detail">
													<h5 class="handle">황보석 대리 / 경영지원팀</h5>
													<div class="post-meta">
														<div class="asker-meta">
															<span class="qa-message-what"></span> <span
																class="qa-message-when"> <span
																class="qa-message-when-data">2016년 09월 02일 09시
																	27분</span>
															</span>
															<!-- <span class="qa-message-who">
												<span class="qa-message-who-pad">by </span>
									...
									<div class="message-item" id="m2">
										<div class="message-inner">
											<div class="message-head clearfix">
												...
												<div class="user-detail">
													<h5 class="handle">유진열 과장 / 경영지원팀</h5>
													<div class="post-meta">
														<div class="asker-meta">
															<span class="qa-message-what"></span> <span
																class="qa-message-when"> <span
																class="qa-message-when-data">2016년 08월 29일 15시
																	27분</span>
															</span>
															<!-- <span class="qa-message-who">
												<span class="qa-message-who-pad">by </span>
											...
											<div class="qa-message-content">사랑해 라고 말하고 싶었지만 늘
												미안하다고만 했던 나</div>
										</div>
									</div>
									...
									<div class="message-item" id="m1">
										<div class="message-inner">
											<div class="message-head clearfix">
												...
												<div class="user-detail">
													<h5 class="handle">James / 베트남 공장</h5>
													<div class="post-meta">
														<div class="asker-meta">
															<span class="qa-message-what"></span> <span
																class="qa-message-when"> <span
																class="qa-message-when-data">2016년 08월 27일 14시
																	27분</span>
															</span>
															<!-- 	<span class="qa-message-who">
												<span class="qa-message-who-pad">by </span>
											...
											<div class="qa-message-content">떠나거든 내 소식이 들려오면 이제는
												모른다고 해줘 언제나 내 맘 속에서 커져만 갔던 너를 조금씩 나도 지우려 해</div>
										</div>
									</div>
